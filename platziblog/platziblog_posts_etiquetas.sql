...
CREATE TABLE `posts_etiquetas` (
  ...
  `eitqueta_id` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `postsetiquetas_post_idx` (`post_id`),
  KEY `postsetiquetas_etiquetas_idx` (`eitqueta_id`),
  CONSTRAINT `postsetiquetas_etiquetas` FOREIGN KEY (`eitqueta_id`) REFERENCES `etiquetas` (`id`),
...
-- Dump completed on 2021-07-08 23:00:28
